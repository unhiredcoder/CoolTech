...
const Hero: React.FC = () => {
    ...
    return (
        <section className="relative pt-24 overflow-hidden bg-gradient-to-br from-white via-[#F5E5E9] to-[#eaf6fb]/30">
            ...
            <div className="absolute top-20 right-10 w-64 h-64 bg-primary/40 rounded-full blur-3xl "></div>
                    ...
                    <div className="relative hidden lg:flex justify-center items-center">
                        ...
                        {heroData.stats.map((stat, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className={`absolute ${index === 0 ? "top-0 left-0" : "bottom-10 right-10"
                                        } bg-white/30 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/30 animate-float-updown ${index === 1 ? "delay-150" : ""
                                        }`}
                                >
