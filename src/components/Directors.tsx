                ...
                <div className="text-center mb-12 px-4">
                    <div className="flex flex-wrap items-center justify-center gap-3 mb-4">
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center">
                            {title.split(' ')[0]}{" "}
                            <span className="bg-primary px-3 py-0.5 sm:py-1 rounded-full shadow-md font-bold inline-block">
                                {title.split(' ')[1]}
                            </span>
                        </h2>
                        <div className="w-10 sm:w-12 h-1 bg-primary rounded-full"></div>
                    </div>
                    <p className="text-muted-foreground text-base sm:text-lg md:text-xl text-center">{subtitle}</p>
                </div>
