                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                    {awards.map((award, idx) => {
                        ...
                        return (
                            <Card
                                key={idx}
                                className="group hover:shadow-2xl transition-all duration-300 border-0 bg-gradient-to-br from-background to-muted rounded-3xl hover:-translate-y-2"
                            >
                                <CardContent className="p-6 sm:p-8 text-center">
                                    <div
                                        className={`w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-r ${award.iconGradient.join(
                                            ' '
                                        )} rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}
                                    >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto">
                        {projectStats.map((stat, idx) => {
                            ...
                            return (
                                <Card
                                    key={idx}
                                    className="text-center p-6 sm:p-8 shadow-xl rounded-3xl border-0"
                                >
                                    <div
                                        className={`w-14 sm:w-16 h-14 sm:h-16 bg-gradient-to-r ${stat.iconGradient.join(
                                            ' '
                                        )} rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4`}
                                    >
                                        <Icon className="w-6 sm:w-8 h-6 sm:h-8 text-secondary   " />
                                    </div>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {images.map((item, index) => (
                            <Card
                                key={index}
                                className="group rounded-none border-none shadow-none bg-none p-0"
                            >
                                <div className="relative overflow-hidden aspect-[16/9]">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-popover-foreground/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                    <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <h4 className="font-bold text-sm sm:text-lg text-secondary">
                                            {item.title}
                                        </h4>
            ...
            <section className="py-16 sm:py-20 ">
                <div className="container mx-auto">
                    ...
                    <div className="text-center mb-12 sm:mb-16">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
                            Detailed insights into our most successful infrastructure projects
                        </p>
                    </div>
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <img
                                        src={study.image}
                                        alt={study.title}
                                        className="rounded-2xl sm:rounded-3xl w-full shadow-xl relative z-10"
                                    />
                                </div>
                                <div>
                                    ...
                                    <Button className="bg-primary hover:bg-red-600 font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-full">
