                ...
                <div className="text-center mb-12 sm:mb-16">
                    <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold">
                            About <span className="bg-primary px-3 py-1 rounded-full shadow-md">CoolTech</span>
                        </h2>
                        <div className="w-10 sm:w-12 h-1 bg-primary rounded-full"></div>
                    </div>
            ...
            <section className="relative pt-20 sm:pt-24 pb-16 sm:pb-20 bg-gradient-to-br from-white via-[#f6f7fb] to-[#eaf6fb]/30">
                <div className="container mx-auto">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mt-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                            {companyOverview.ctaButtons.map((btn, idx) => (
                                <Button
                                    ...
                                    className={`${btn.type === 'primary' ? 'bg-primary hover:bg-[#dc2626] text-white' : 'border-2 border-[#e63946] text-[#e63946] hover:bg-primary hover:text-white'} font-bold px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg rounded-full shadow-lg hover:shadow-xl transition-all`}
                                >
                                    {btn.text}
